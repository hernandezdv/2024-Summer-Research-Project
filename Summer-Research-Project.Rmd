...
The following will determine crude ORs

```{r}
sdat$raceneth <- relevel(factor(sdat$raceneth), ref = "White")
```


```{r}
tab.heterosexualdata <- table(heterosexualdata$raceneth, heterosexualdata$QN10)
tab.sexualminoritydata <- table(sexualminoritydata$raceneth, sexualminoritydata$QN10)
```
