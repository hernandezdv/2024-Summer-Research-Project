...
sdat <- sdat %>%
  mutate(sexual_identity = case_when(Q65 == 1 ~ "Heterosexual",
                                 	...
                                 	TRUE ~ "N/A"))
#Code creates categorical levels as opposed to only numbers and allows for easier interpretation
```
...
```{r}
ovars <- c("QN10", "QN11", "QN13", "QN28", "QN83", "QN30", "QN41", "QN59", "QN77", "QN69", "QN87", "QN18", "QN97")
```
